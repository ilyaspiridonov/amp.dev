...
## Füge Styles zu einer Seite hinzu <a name="add-styles-to-a-page"></a>
...
Definiere CSS im Tag `<style amp-custom>` innerhalb des Headers des Dokuments. Auf jeder AMP Seite ist nur ein `<style amp-custom>` Tag zulässig.
...
## Reaktionsschnelle Layout Elemente
...
## Stelle Platzhalter & Fallbacks bereit
...
## Art Direction für deine Bilder
...
## Validiere deine Styles und dein Layout
