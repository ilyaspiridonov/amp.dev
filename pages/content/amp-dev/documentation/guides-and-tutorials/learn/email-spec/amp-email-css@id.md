...
## Menerapkan CSS <a name="applying-css"></a>

### Lembar gaya internal <a name="internal-stylesheet"></a>
...
### Gaya inline <a name="inline-styles"></a>

Selain lembar gaya internal, gaya inline dapat ditentukan pada elemen apa pun dengan menggunakan [atribut `style`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style).

### Lembar gaya eksternal <a name="external-stylesheet"></a>
...
## Pemilih CSS yang Didukung <a name="supported-css-selectors"></a>

### Pemilih sederhana <a name="simple-selectors"></a>

- [Pemilih jenis](https://developer.mozilla.org/en-US/docs/Web/CSS/Type_selectors) `elementname`
...
## Properti CSS yang Didukung <a name="supported-css-properties"></a>
...
### Pembatasan tambahan <a name="additional-restrictions"></a>
...
Satu-satunya [at-rule](https://developer.mozilla.org/en-US/docs/Web/CSS/At-rule) yang didukung saat ini adalah `@media`. Kunjungi [Fitur-fitur media](#media-features) untuk mendapatkan informasi selengkapnya.

### Font kustom (`@font-face`) <a name="custom-fonts-font-face"></a>

Font kustom **tidak** didukung di dalam AMP untuk Email.

## Fitur-fitur media <a name="media-features"></a>
